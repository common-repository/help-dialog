jQuery(document).ready(function ($) {
   ...
   ************************************************************************************************/
    ...
    function loadEditWidgetForm(element) {
        ...
        let $activeWidgetTab = element ? $(element.target).parents('.ephd-wp__widget-tab__item') : $('.ephd-wp__widget-tab__item.ephd-wp__widget-tab--active');
        let widget_id = $activeWidgetTab.find('.ephd_edit_widget').data("id");
        let widget_count = $activeWidgetTab.parents(".ephd-admin__section-wrap").find(".ephd-wp__widget-tab__item").length;
        widget_count++;
    ...
    $(document).on("click", '.ephd-wp__widget-tab__item .ephd_edit_widget', function(e) {
    ...
    function (e) {
      ...
      ephd_send_ajax(postData, function (response) {
        if (!response.error && typeof response.message != "undefined") {
          ...
          setTimeout(function () {
            $(
              ".ephd-wp__widget-form .ephd-wp__widget-action__draft-btn"
            ).trigger("click");
          }, 50);
        }
      });
  ...
  $(document).on(
    "click",
    ".ephd-wp__widget-form .ephd-wp__widget-action__publish-btn, .ephd-wp__widget-form .ephd-wp__widget-action__draft-btn",
    function (e) {
      e.preventDefault();
  ...
  $(document).on(
    "click",
    ".ephd-wp__widget-action__save-options-toggle",
    function () {
      $(this)
        .closest(".ephd-wp__widget-form")
        .find(".ephd-wp__widget-action__save-options-list")
        .toggle();
    }
  );
