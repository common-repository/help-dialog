...
class EPHD_HTML_Admin {
	...
	public static function display_admin_form_header( $header_config ) {
		...
		$status_text =  isset( $header_config['status_text'] ) ? $header_config['status_text'] : esc_html__( 'Status: ', 'help-dialog' );    ?>
		...
		<div class="ephd-admin__form__header">
			<div class="ephd-admin__form-title">
				...
				<div class="ephd-admin__form-text-container">
					<span class="ephd-admin__form-desc"><?php echo esc_html( $status_text ); ?>
                        <span class="ephd-admin__form-status ephd--status-<?php echo esc_html( strtolower( $header_config['status'] ) ); ?>"><?php echo esc_html( $header_config['status'] ); ?></span>
                    </span>
				</div>
			</div><?php
