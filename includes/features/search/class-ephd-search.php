...
class EPHD_Search {
	...
	public static function search( $is_front=true ) {
		...
		$no_results_sc = '<div class="ephd-hd-no-results__img"><img alt="' . esc_attr( 'No FAQs Defined', 'help-dialog' ) . '" src="' . esc_url( Echo_Help_Dialog::$plugin_url . 'img/no-faqs-defined.jpeg' ) . '" ></div>' .
