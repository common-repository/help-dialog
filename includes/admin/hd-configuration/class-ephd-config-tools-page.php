...
class EPHD_Config_Tools_Page {
	...
	public static function get_tools_view_config() {
		return array(
			...
			// Top Panel Item
			'label_text' => esc_html__( 'Tools', 'help-dialog' ),
			...
			'secondary'  => array(
				...
				array(
					...
					'label_text' => esc_html__( 'Export HD', 'help-dialog' ),
				...
				array(
					...
					// Secondary Panel Item
					'label_text' => esc_html__( 'Import HD', 'help-dialog' ),
	...
	private static function get_import_box() {
        ...
        <div class="ephd-admin-info-box">
            <div class="ephd-admin-info-box__body">
                <p><?php echo esc_html__( 'This import will overwrite the following HD settings:', 'help-dialog' ); ?></p>
	...
	private static function display_import_export_info() {  ?>
        <ul>
            <li><?php esc_html_e( 'Configuration for all text, styles, features.', 'help-dialog' ); ?></li>
        </ul>
        <p><?php esc_html_e( 'Instructions:', 'help-dialog' ); ?></p>
        <ul>
            <li><?php esc_html_e( 'Test import and export on your staging or test site before importing configuration in production.', 'help-dialog' ); ?></li>
            <li><?php esc_html_e( 'Always back up your database before starting the import.', 'help-dialog' ); ?></li>
            <li><?php esc_html_e( 'Preferably run import outside of business hours.', 'help-dialog' ); ?></li>
        </ul>   <?php
	}
