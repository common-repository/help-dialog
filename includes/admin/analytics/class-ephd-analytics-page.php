...
class EPHD_Analytics_Page {
	...
	private function get_analytics_tab_boxes_list_config() {
		...
		return [
			...
			// REACH
			'reach'      => [
				//'tab_intro' => esc_html__( 'Reach analytics shows initial user interaction with the Help Dialog. Did user open the Help Dialog and which pages did users interact with the most and least? By default, admins, editors, and authors have their interactions with Help Dialog excluded from analytics.', 'help-dialog' ),
