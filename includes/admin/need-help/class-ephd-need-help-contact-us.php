...
class EPHD_Need_Help_Contact_Us {
	...
	public static function get_page_view_config() {
		...
		return array(
			...
			// Top Panel Item
			'label_text' => esc_html__( 'Contact Us', 'help-dialog' ),
			...
			<div class="ephd-nh__section-container ephd-nh__section--three-col-cta">
				...
				<div class="ephd-nh__section__body-container"> <?php
					...
					EPHD_HTML_Forms::call_to_action_box( array(
						...
						'title'         => esc_html__( 'Cannot Find a Feature?', 'help-dialog' ),
						'content'       => '<p>' . esc_html__( 'We can help you find it or add it to our road map if it is missing.', 'help-dialog' ) . '</p>',
						'btn_text'      => esc_html__( 'Ask About a Feature', 'help-dialog' ),
					...
					EPHD_HTML_Forms::call_to_action_box( array(
						...
						'title'         => esc_html__( 'Submit an Issue', 'help-dialog' ),
						'content'       => '<p>' . esc_html__( 'Submit a technical support question for something that is not working correctly.', 'help-dialog' ) . '</p>
										<p>' . esc_html__( 'We usually reply within an hour.', 'help-dialog' ) . '</p>',
						'btn_text'      => esc_html__( 'Contact Our Support', 'help-dialog' ),
					...
					EPHD_HTML_Forms::call_to_action_box( array(
						...
						'title'         => esc_html__( 'General and Pre-Sale Questions', 'help-dialog' ),
						'content'       => '<p>' . esc_html__( 'Do you have a pre-sale question, and do you need some clarification?', 'help-dialog' ) . '</p>',
						'btn_text'      => esc_html__( 'Ask a Question', 'help-dialog' ),
