...
class EPHD_Need_Help_Features {
	...
	public static function get_page_view_config() {
		...
		return array(
			...
			// Top Panel Item
			'label_text' => esc_html__( 'Features', 'help-dialog' ),
	...
	private static function get_feature_box( $feature ) {
		...
		<div class="ephd-nh__feature-container__col ephd-nh__feature__content-col">
			...
			<div class="ephd-nh__feature-links">  <?php
				...
				if ( ! EPHD_Utilities::is_plugin_enabled( $feature['plugin'] ) ) {
					...
					<a class="ephd-nh__feature-link" href="<?php echo esc_url( $plugin_url ); ?>" target="_blank"><span><?php esc_html_e( 'Learn More', 'help-dialog' ); ?></span></a>    <?php
				}				?>
        ...
        <div class="ephd-nh__feature-container__col ephd-nh__feature__status-col">    <?php
			...
			// Plugin is not enabled
                ...
                echo '<a class="ephd-nh__feature-status ephd-nh__feature--disabled ephd-success-btn" href="' . EPHD_Core_Utilities::get_plugin_sales_page( $feature['plugin'] ) . '" target="_blank"><span>' . esc_html__( 'Upgrade', 'help-dialog' ) . '</span></a>';//phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}   ?>
	...
	private static function get_features_config() {
		...
		return [
			[
				...
				'name'      => esc_html__( 'Search FAQs and Knowledge Base Articles', 'help-dialog' ),
				'desc'      => esc_html__( 'Users can search FAQs and a specific knowledge base for articles from the Help Dialog widget.', 'help-dialog' ),
				'config'    => admin_url( 'admin.php?page=ephd-help-dialog-widgets' ),
				'docs'      => 'https://www.helpdialog.com/documentation/searching-content/',
			],
			[
				'category'  => 'help-dialog',
				'name'      => esc_html__( 'Contact Form', 'help-dialog' ),
				'desc'      => esc_html__( 'Users can submit a contact form to ask questions or get more help from the Help Dialog window.', 'help-dialog' ),
			...
			[
				'category'  => 'help-dialog',
				'name'      => esc_html__( 'Analytics', 'help-dialog' ),
				'desc'      => esc_html__( 'Basic analytics about the number of times Help Dialog was invoked and the number of user searches and submitted requests.', 'help-dialog' ),
			...
			[
				'category'  => 'help-dialog',
				'name'      => esc_html__( 'Bots Protection', 'help-dialog' ),
				'desc'      => esc_html__( 'The contact form is protected from submissions by bots.', 'help-dialog' ),
			],
			[
				'plugin'    => 'pro',
				'category'  => 'help-dialog',
				'name'      => esc_html__( 'Full Analytics', 'help-dialog' ),
				'desc'      => esc_html__( 'Extensive analytics about user interaction with the Help Dialog including FAQs, search and contact form.', 'help-dialog' ),
				'view'      => admin_url( 'admin.php?page=ephd-plugin-analytics' ),
				'docs'      => 'https://www.helpdialog.com/documentation/analytics-overview/',
			],
			[
				'category'  => 'help-dialog',
				'name'      => esc_html__( 'AI Content Writing', 'help-dialog' ),
				'desc'      => esc_html__( 'Get help with writing your FAQs using AI. Check your spelling and grammar, generate variations on questions and choose the best one and generate answers to questions.', 'help-dialog' ),
			],
			[
				'category'  => 'design',
				'name'      => esc_html__( 'Pre-made Color Designs', 'help-dialog' ),
				'desc'      => esc_html__( 'Choose from pre-made designs with a variety of colors. You can customize the colors set you choose.', 'help-dialog' ),
				'config'    => admin_url( 'admin.php?page=ephd-help-dialog-widgets' ),
			],
			[
				'category'  => 'compatibility',
				'name'      => esc_html__( 'RTL (Right-To-Left) Styling', 'help-dialog' ),
				'desc'      => esc_html__( 'This Help Dialog fully supports RTL CSS files for both admin screens and frontend pages.', 'help-dialog' ),
			],
			[
				'category'  => 'compatibility',
				'name'      => esc_html__( 'Multisite Compatible', 'help-dialog' ),
				'desc'      => esc_html__( 'Help Dialog works with the WordPress multi-site feature.', 'help-dialog' ),
			],
			[
				'category'  => 'compatibility',
				'name'      => esc_html__( 'Multi-language Support', 'help-dialog' ),
				'desc'      => esc_html__( 'Change or translate any text label on the front-end using any of 12 translated languages.', 'help-dialog' ),
			],
			[
				'category'  => 'compatibility',
				'name'      => esc_html__( 'WCAG accessibility', 'help-dialog' ),
				'desc'      => esc_html__( 'Complies with basic WCAG accessibility for people with disabilities, including blindness.', 'help-dialog' ),
			],
		];
	}
	...
	private static function get_categories_config() {
		return [
			[
				'name'  => 'help-dialog',
				'title' => esc_html__( 'Overview', 'help-dialog' ),
				'icon'  => 'ephdfa ephdfa-comments-o',
			],
			[
				'name'  => 'design',
				'title' => esc_html__( 'HD Design', 'help-dialog' ),
				'icon'  => 'ephdfa ephdfa-paint-brush',
			],
			[
				'name'  => 'compatibility',
				'title' => esc_html__( 'Compatibility', 'help-dialog' ),
				'icon'  => 'ephdfa ephdfa-handshake-o',
			],
			/* [
				'name'  => 'advanced',
				'title' => esc_html__( 'Advanced', 'help-dialog' ),
				'icon'  => 'ephdfa ephdfa-rocket',
			], */
		];
	}
