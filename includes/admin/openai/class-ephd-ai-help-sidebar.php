				...
				<div class="ephd-ai-help-sidebar__main">
					...
					<div class="ephd-ai-help-sidebar__actions">
						<div class="ephd-ai-help-sidebar__actions-question">
							...
							EPHD_HTML_Elements::submit_button_v2( esc_html__( 'Fix Spelling and Grammar', 'help-dialog' ), 'ephd_fix_spelling_and_grammar', 'ephd-ai-help-sidebar__action-wrap', '', false, false, 'ephd-ai__question-fix-spelling-and-grammar-btn' );
							EPHD_HTML_Elements::submit_button_v2( esc_html__( 'Generate 5 Variations', 'help-dialog' ), 'ephd_create_text_based_on_input', 'ephd-ai-help-sidebar__action-wrap', '', false, false, 'ephd-ai__question-create-five-alternatives-btn' );  ?>
						</div>
						<div class="ephd-ai-help-sidebar__actions-answer">
							...
							EPHD_HTML_Elements::submit_button_v2( esc_html__( 'Fix Spelling and Grammar', 'help-dialog' ), 'ephd_fix_spelling_and_grammar', 'ephd-ai-help-sidebar__action-wrap', '', false, false, 'ephd-ai__answer-fix-spelling-and-grammar-btn' );
							EPHD_HTML_Elements::submit_button_v2( esc_html__( 'Generate 5 Variations', 'help-dialog' ), 'ephd_create_text_based_on_input', 'ephd-ai-help-sidebar__action-wrap', '', false, false, 'ephd-ai__answer-create-five-alternatives-btn' );
							EPHD_HTML_Elements::submit_button_v2( esc_html__( 'Generate Answer To My Question', 'help-dialog' ), 'ephd_create_text_based_on_input', 'ephd-ai-help-sidebar__action-wrap', '', false, false, 'ephd-ai__create-answer-based-on-question-btn' );  ?>
						</div>
					</div>
				</div>
