...
class EPHD_Widgets_Page {
     ...
     * @return false|string
     */
    public function get_widget__preview_box_tab_navigation( $widget_config ) {

        ob_start(); ?>

		<div class="ephd-wp__widgets-tab-container">
			<div class="ephd-wp__widgets-tab--heading">				<?php
				$widget_count = count( $widget_config );
				$widget_text = sprintf( _n( 'You have %d widgets available. Click the widget tab below to edit it.', 'You have %d widgets available. Click the widget tab below to edit them.', $widget_count, 'help-dialog' ), $widget_count );	?>
				<span class="ephd-widget-count"><?php echo esc_html( $widget_text ); ?></span>
			</div>
			<div class="ephd-wp__widgets-tabs">
				<div class="ephd-wp__widget-tabs__wrapper"><?php
					...
					foreach (  $widget_config as $widget ): ?>
						<div class="ephd-wp__widget-tab__item ephd-wp__widget-tab--<?php echo esc_attr( $widget['widget_id'] ) . ( ( $i++ == 0 ) ? ' ephd-wp__widget-tab--active' : '' ); ?>">
							<input type="button" value="<?php echo esc_attr( $widget['widget_name'] ); ?>" class="ephd_edit_widget" data-id="<?php echo esc_attr( $widget['widget_id'] ); ?>">
						</div>  <?php
					endforeach; ?>
	...
	private static function get_widget_form_actions_html( $widget ) {
        ...
        <div class="ephd-wp__widget-action__save-wrap">
            <div class="ephd-wp__widget-action__save-btns-wrap">
                            <?php
                    $save_button_title = ( $widget['widget_status'] == 'published' && $widget['widget_id'] > 0 ) ? esc_html__( 'Save', 'help-dialog' ) : esc_html__( 'Save and Publish', 'help-dialog' );
			...
			<div class="ephd-wp__widget-action__save-btn ephd-wp__widget-action__save-options-list" style="display:none;">   <?php
                EPHD_HTML_Elements::submit_button_v2( esc_html__( 'Save as Draft', 'help-dialog' ), 'ephd_draft_widget', 'ephd-wp__widget-action__draft-btn', '', false, '', 'ephd-success-btn' );   ?>
            </div>
        </div>  <?php
